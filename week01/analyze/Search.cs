...
public static class Search
{
    ...
    //THIS IS O(n) the worst scenario is iterating N times if the target is the last item or is not in the array
    ...
    //THIS ONE is O(log N), because searching I times the middle is equal to logarithm base 2, and N because there is a loop function
}